...
public class AddProductActivity extends Activity {
        ...
        captureImageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (ContextCompat.checkSelfPermission(AddProductActivity.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(AddProductActivity.this, new String[]{Manifest.permission.CAMERA}, CAMERA_PERMISSION_REQUEST_CODE);
                } else {
        ...
        firestore.collection("Product_Dataset")
                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        ...
                        ArrayAdapter<String> productNameAdapter = new ArrayAdapter<>(AddProductActivity.this, android.R.layout.simple_dropdown_item_1line, productNames);
                        productNameAutoComplete.setAdapter(new FilteredArrayAdapter<>(AddProductActivity.this, android.R.layout.simple_dropdown_item_1line, productNames));
                    } else {
                        Toast.makeText(AddProductActivity.this, "Error fetching product names: " + task.getException(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
        ...
        firestore.collection("Product_Dataset")
                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        ...
                        ArrayAdapter<String> productTypeAdapter = new ArrayAdapter<>(AddProductActivity.this, android.R.layout.simple_dropdown_item_1line, productTypes);
                        productTypeAutoComplete.setAdapter(productTypeAdapter);
                    } else {
                        Toast.makeText(AddProductActivity.this, "Error fetching product types: " + task.getException(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
            ...
            Task<Uri> urlTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if (task.isSuccessful()) {
                            ...
                            public void onProductIdReceived(String productId) {
                                ...
                                firestore.collection("Products")
                                        ...
                                        .addOnSuccessListener(documentReference -> {
                                            ...
                                            String message = "Product added: " + productName + ", Type: " + productType + ", Price: " + price + " per kg, Quantity: " + quantity + " kg";
                                        ...
                                        .addOnFailureListener(e -> {
                                            ...
                                            Toast.makeText(AddProductActivity.this, "Error adding product to Firestore: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                                        });
                            }
                        });
                    } else {
                        ...
                        // Handle failures
                        Toast.makeText(AddProductActivity.this, "Error uploading image to Firebase Storage", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        } else {
            // Handle case where user is not signed in
            Toast.makeText(AddProductActivity.this, "Error: User not signed in", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == REQUEST_IMAGE_CAPTURE && resultCode == Activity.RESULT_OK) {
            try {
                ...
                if (extras != null) {
                    ...
                    if (capturedImage != null) {
                        ...
                        Toast.makeText(AddProductActivity.this, "Error: Captured image is null", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(AddProductActivity.this, "Error: Extras bundle is null", Toast.LENGTH_SHORT).show();
                }
            } catch (Exception e) {
                e.printStackTrace();
            ...
            Toast.makeText(AddProductActivity.this, "Error: Image capture failed", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == CAMERA_PERMISSION_REQUEST_CODE) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(AddProductActivity.this, "Camera permission denied", Toast.LENGTH_SHORT).show();
            }
        }
    }
