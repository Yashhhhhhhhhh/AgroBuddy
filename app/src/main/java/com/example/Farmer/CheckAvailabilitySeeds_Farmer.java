...
public class CheckAvailabilitySeeds_Farmer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_check_availability_seeds_farmer);
        ...
        firestore.collection("Seeds")
                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(this, "Error Handling Database", Toast.LENGTH_SHORT).show();
                    }
                });
