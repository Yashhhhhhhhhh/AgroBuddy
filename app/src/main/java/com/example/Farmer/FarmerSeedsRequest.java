...
public class FarmerSeedsRequest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_farmer_seeds_request);
        ...
        if (!quantity.isEmpty()) {
            ...
            fetchProductId(productType, new ProductIdCallback() {
                ...
                public void onProductIdReceived(String productId) {
                    CollectionReference productsCollection = firestore.collection("SeedRequest");
                    ...
                    FarmerSeedsData farmerSeedsData = new FarmerSeedsData(productId,requestId, username, productName, productType, quantity, "Requested");
